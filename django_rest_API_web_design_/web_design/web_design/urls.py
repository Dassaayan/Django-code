...
urlpatterns = [
    ...
    url(r'^html_page/demo',views.Index_html_demo,name='Index_html_demo'),
    url(r'^data/save',views.login_details),
    url(r'^bootstrap/page/learning',views.bootstrap_html,name='bootstrap_html'),
    url(r'^Cosco/api',include('Cosco_api_design.urls')),
    url(r'^Ceva/api',include('ceva_shipment_api_design.urls'))
]
